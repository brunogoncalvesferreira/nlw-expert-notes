...
export function App() {
  ...
  return (
    <div className="mx-auto max-w-6xl my-12 px-5 space-y-6 md-px-0">
      <img src={logo} alt="Logo NLW Expert Notes" />

      <form className='w-full'>
        <input 
          type="text"
          placeholder='Busque em suas notas...'
          className='w-full bg-transparent outline-none text-3xl tracking-tight font-semibold placeholder:text-slate-500' 
